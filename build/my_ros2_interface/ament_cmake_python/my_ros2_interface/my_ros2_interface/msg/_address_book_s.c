...
bool my_ros2_interface__msg__address_book__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_ros2_interface.msg._address_book.AddressBook", full_classname_dest, 47) == 0);
  }
  my_ros2_interface__msg__AddressBook * ros_message = _ros_message;
  {  // first_name
...
PyObject * my_ros2_interface__msg__address_book__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_ros2_interface.msg._address_book");
