...
#include "my_ros2_interface/action/detail/fibonacci__rosidl_typesupport_fastrtps_c.h"
...
using _Fibonacci_Goal__ros_msg_type = my_ros2_interface__action__Fibonacci_Goal;
...
size_t get_serialized_size_my_ros2_interface__action__Fibonacci_Goal(
  const void * untyped_ros_message,
...
static uint32_t _Fibonacci_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_ros2_interface__action__Fibonacci_Goal(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t max_serialized_size_my_ros2_interface__action__Fibonacci_Goal(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_ros2_interface__action__Fibonacci_Goal;
    is_plain =
      (
...
static size_t _Fibonacci_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_ros2_interface__action__Fibonacci_Goal(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_Goal)() {
...
using _Fibonacci_Result__ros_msg_type = my_ros2_interface__action__Fibonacci_Result;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t get_serialized_size_my_ros2_interface__action__Fibonacci_Result(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Fibonacci_Result__ros_msg_type * ros_message = static_cast<const _Fibonacci_Result__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_ros2_interface__action__Fibonacci_Result(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t max_serialized_size_my_ros2_interface__action__Fibonacci_Result(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_ros2_interface__action__Fibonacci_Result;
    is_plain =
      (
...
static size_t _Fibonacci_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_ros2_interface__action__Fibonacci_Result(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_Result)() {
...
using _Fibonacci_Feedback__ros_msg_type = my_ros2_interface__action__Fibonacci_Feedback;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t get_serialized_size_my_ros2_interface__action__Fibonacci_Feedback(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Fibonacci_Feedback__ros_msg_type * ros_message = static_cast<const _Fibonacci_Feedback__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_ros2_interface__action__Fibonacci_Feedback(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t max_serialized_size_my_ros2_interface__action__Fibonacci_Feedback(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_ros2_interface__action__Fibonacci_Feedback;
    is_plain =
      (
...
static size_t _Fibonacci_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_ros2_interface__action__Fibonacci_Feedback(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_Feedback)() {
...
// already included above
// #include "my_ros2_interface/action/detail/fibonacci__functions.h"  // goal
...
using _Fibonacci_SendGoal_Request__ros_msg_type = my_ros2_interface__action__Fibonacci_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t get_serialized_size_my_ros2_interface__action__Fibonacci_SendGoal_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Fibonacci_SendGoal_Request__ros_msg_type * ros_message = static_cast<const _Fibonacci_SendGoal_Request__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_my_ros2_interface__action__Fibonacci_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_ros2_interface__action__Fibonacci_SendGoal_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t max_serialized_size_my_ros2_interface__action__Fibonacci_SendGoal_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_my_ros2_interface__action__Fibonacci_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_ros2_interface__action__Fibonacci_SendGoal_Request;
    is_plain =
      (
...
static size_t _Fibonacci_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_ros2_interface__action__Fibonacci_SendGoal_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_SendGoal_Request)() {
...
using _Fibonacci_SendGoal_Response__ros_msg_type = my_ros2_interface__action__Fibonacci_SendGoal_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t get_serialized_size_my_ros2_interface__action__Fibonacci_SendGoal_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Fibonacci_SendGoal_Response__ros_msg_type * ros_message = static_cast<const _Fibonacci_SendGoal_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_ros2_interface__action__Fibonacci_SendGoal_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t max_serialized_size_my_ros2_interface__action__Fibonacci_SendGoal_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_ros2_interface__action__Fibonacci_SendGoal_Response;
    is_plain =
      (
...
static size_t _Fibonacci_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_ros2_interface__action__Fibonacci_SendGoal_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_SendGoal_Response)() {
...
using _Fibonacci_SendGoal_Event__ros_msg_type = my_ros2_interface__action__Fibonacci_SendGoal_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_SendGoal_Request
      )()->data);
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_SendGoal_Response
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      my_ros2_interface__action__Fibonacci_SendGoal_Request__Sequence__fini(&ros_message->request);
    }
    if (!my_ros2_interface__action__Fibonacci_SendGoal_Request__Sequence__init(&ros_message->request, size)) {
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      my_ros2_interface__action__Fibonacci_SendGoal_Response__Sequence__fini(&ros_message->response);
    }
    if (!my_ros2_interface__action__Fibonacci_SendGoal_Response__Sequence__init(&ros_message->response, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t get_serialized_size_my_ros2_interface__action__Fibonacci_SendGoal_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Fibonacci_SendGoal_Event__ros_msg_type * ros_message = static_cast<const _Fibonacci_SendGoal_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_my_ros2_interface__action__Fibonacci_SendGoal_Request(
  ...
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_my_ros2_interface__action__Fibonacci_SendGoal_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_ros2_interface__action__Fibonacci_SendGoal_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t max_serialized_size_my_ros2_interface__action__Fibonacci_SendGoal_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_my_ros2_interface__action__Fibonacci_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_my_ros2_interface__action__Fibonacci_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_ros2_interface__action__Fibonacci_SendGoal_Event;
    is_plain =
      (
...
static size_t _Fibonacci_SendGoal_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_ros2_interface__action__Fibonacci_SendGoal_Event(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_SendGoal_Event)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_SendGoal)() {
...
using _Fibonacci_GetResult_Request__ros_msg_type = my_ros2_interface__action__Fibonacci_GetResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t get_serialized_size_my_ros2_interface__action__Fibonacci_GetResult_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Fibonacci_GetResult_Request__ros_msg_type * ros_message = static_cast<const _Fibonacci_GetResult_Request__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_ros2_interface__action__Fibonacci_GetResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t max_serialized_size_my_ros2_interface__action__Fibonacci_GetResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_ros2_interface__action__Fibonacci_GetResult_Request;
    is_plain =
      (
...
static size_t _Fibonacci_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_ros2_interface__action__Fibonacci_GetResult_Request(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_GetResult_Request)() {
...
// already included above
// #include "my_ros2_interface/action/detail/fibonacci__functions.h"  // result
...
using _Fibonacci_GetResult_Response__ros_msg_type = my_ros2_interface__action__Fibonacci_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_Result
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t get_serialized_size_my_ros2_interface__action__Fibonacci_GetResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Fibonacci_GetResult_Response__ros_msg_type * ros_message = static_cast<const _Fibonacci_GetResult_Response__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_my_ros2_interface__action__Fibonacci_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_ros2_interface__action__Fibonacci_GetResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t max_serialized_size_my_ros2_interface__action__Fibonacci_GetResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_my_ros2_interface__action__Fibonacci_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_ros2_interface__action__Fibonacci_GetResult_Response;
    is_plain =
      (
...
static size_t _Fibonacci_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_ros2_interface__action__Fibonacci_GetResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_GetResult_Response)() {
...
using _Fibonacci_GetResult_Event__ros_msg_type = my_ros2_interface__action__Fibonacci_GetResult_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_GetResult_Request
      )()->data);
    size_t size = ros_message->request.size;
    auto array_ptr = ros_message->request.data;
    if (size > 1) {
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_GetResult_Response
      )()->data);
    size_t size = ros_message->response.size;
    auto array_ptr = ros_message->response.data;
    if (size > 1) {
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: request
  {
    ...
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->request.data) {
      my_ros2_interface__action__Fibonacci_GetResult_Request__Sequence__fini(&ros_message->request);
    }
    if (!my_ros2_interface__action__Fibonacci_GetResult_Request__Sequence__init(&ros_message->request, size)) {
      fprintf(stderr, "failed to create array for field 'request'");
      return false;
    }
    auto array_ptr = ros_message->request.data;
  ...
  // Field name: response
  {
    ...
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->response.data) {
      my_ros2_interface__action__Fibonacci_GetResult_Response__Sequence__fini(&ros_message->response);
    }
    if (!my_ros2_interface__action__Fibonacci_GetResult_Response__Sequence__init(&ros_message->response, size)) {
      fprintf(stderr, "failed to create array for field 'response'");
      return false;
    }
    auto array_ptr = ros_message->response.data;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t get_serialized_size_my_ros2_interface__action__Fibonacci_GetResult_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Fibonacci_GetResult_Event__ros_msg_type * ros_message = static_cast<const _Fibonacci_GetResult_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_my_ros2_interface__action__Fibonacci_GetResult_Request(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_my_ros2_interface__action__Fibonacci_GetResult_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_ros2_interface__action__Fibonacci_GetResult_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t max_serialized_size_my_ros2_interface__action__Fibonacci_GetResult_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_my_ros2_interface__action__Fibonacci_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_my_ros2_interface__action__Fibonacci_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_ros2_interface__action__Fibonacci_GetResult_Event;
    is_plain =
      (
      offsetof(DataType, response) +
      last_member_size
...
static size_t _Fibonacci_GetResult_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_ros2_interface__action__Fibonacci_GetResult_Event(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_GetResult_Event)() {
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_GetResult)() {
...
// already included above
// #include "my_ros2_interface/action/detail/fibonacci__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _Fibonacci_FeedbackMessage__ros_msg_type = my_ros2_interface__action__Fibonacci_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t get_serialized_size_my_ros2_interface__action__Fibonacci_FeedbackMessage(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Fibonacci_FeedbackMessage__ros_msg_type * ros_message = static_cast<const _Fibonacci_FeedbackMessage__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_my_ros2_interface__action__Fibonacci_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_my_ros2_interface__action__Fibonacci_FeedbackMessage(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t max_serialized_size_my_ros2_interface__action__Fibonacci_FeedbackMessage(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_my_ros2_interface__action__Fibonacci_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_ros2_interface__action__Fibonacci_FeedbackMessage;
    is_plain =
      (
...
static size_t _Fibonacci_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_ros2_interface__action__Fibonacci_FeedbackMessage(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_ros2_interface, action, Fibonacci_FeedbackMessage)() {
