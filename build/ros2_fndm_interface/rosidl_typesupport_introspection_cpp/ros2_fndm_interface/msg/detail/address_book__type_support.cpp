...
{
  new (message_memory) ros2_fndm_interface::msg::AddressBook(_init);
}

void AddressBook_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros2_fndm_interface::msg::AddressBook *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AddressBook_message_member_array[4] = {
  {
    ...
    offsetof(ros2_fndm_interface::msg::AddressBook, first_name),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_fndm_interface::msg::AddressBook, last_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_fndm_interface::msg::AddressBook, phone_number),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros2_fndm_interface::msg::AddressBook, phone_type),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AddressBook_message_members = {
  ...
  4,  // number of fields
  sizeof(ros2_fndm_interface::msg::AddressBook),
...
{
  return &::ros2_fndm_interface::msg::rosidl_typesupport_introspection_cpp::AddressBook_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_fndm_interface, msg, AddressBook)() {
  return &::ros2_fndm_interface::msg::rosidl_typesupport_introspection_cpp::AddressBook_message_type_support_handle;
}
