...
#include "ros2_fndm_interface/action/detail/fibonacci__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros2_fndm_interface::action::Fibonacci_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_fndm_interface::action::Fibonacci_Goal & ros_message)
{
  // Member: order
  cdr >> ros_message.order;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_fndm_interface::action::Fibonacci_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_fndm_interface::action::Fibonacci_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_fndm_interface::action::Fibonacci_Goal *>(
    untyped_ros_message);
...
{
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_fndm_interface, action, Fibonacci_Goal)() {
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_fndm_interface
cdr_serialize(
  const ros2_fndm_interface::action::Fibonacci_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_fndm_interface::action::Fibonacci_Result & ros_message)
{
  // Member: result_sequence
  {
    cdr >> ros_message.result_sequence;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_fndm_interface::action::Fibonacci_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_fndm_interface::action::Fibonacci_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_fndm_interface::action::Fibonacci_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_fndm_interface, action, Fibonacci_Result)() {
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_fndm_interface
cdr_serialize(
  const ros2_fndm_interface::action::Fibonacci_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_fndm_interface::action::Fibonacci_Feedback & ros_message)
{
  // Member: partial_sequence
  {
    cdr >> ros_message.partial_sequence;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_fndm_interface::action::Fibonacci_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_fndm_interface::action::Fibonacci_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_fndm_interface::action::Fibonacci_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_fndm_interface, action, Fibonacci_Feedback)() {
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_Feedback__handle;
}
...
// functions for ros2_fndm_interface::action::Fibonacci_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_fndm_interface
cdr_serialize(
  const ros2_fndm_interface::action::Fibonacci_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ...
    cdr);
  // Member: goal
  ros2_fndm_interface::action::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.goal,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_fndm_interface::action::Fibonacci_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  // Member: goal
  ros2_fndm_interface::action::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment +=
    ros2_fndm_interface::action::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_fndm_interface::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_fndm_interface::action::Fibonacci_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_fndm_interface::action::Fibonacci_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_fndm_interface::action::Fibonacci_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_fndm_interface, action, Fibonacci_SendGoal_Request)() {
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_fndm_interface
cdr_serialize(
  const ros2_fndm_interface::action::Fibonacci_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_fndm_interface::action::Fibonacci_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_fndm_interface::action::Fibonacci_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_fndm_interface::action::Fibonacci_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_fndm_interface::action::Fibonacci_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_fndm_interface, action, Fibonacci_SendGoal_Response)() {
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Response__handle;
}
...
// functions for ros2_fndm_interface::action::Fibonacci_SendGoal_Request already declared above

// functions for ros2_fndm_interface::action::Fibonacci_SendGoal_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_fndm_interface
cdr_serialize(
  const ros2_fndm_interface::action::Fibonacci_SendGoal_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_fndm_interface::action::Fibonacci_SendGoal_Event & ros_message)
{
  // Member: info
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_fndm_interface::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_fndm_interface::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_fndm_interface::action::Fibonacci_SendGoal_Event;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_fndm_interface::action::Fibonacci_SendGoal_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_fndm_interface::action::Fibonacci_SendGoal_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_fndm_interface, action, Fibonacci_SendGoal_Event)() {
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal_Event__handle;
}
...
static const rosidl_service_type_support_t _Fibonacci_SendGoal__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<ros2_fndm_interface::action::Fibonacci_SendGoal_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<ros2_fndm_interface::action::Fibonacci_SendGoal_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<ros2_fndm_interface::action::Fibonacci_SendGoal_Event>(),
...
{
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_fndm_interface, action, Fibonacci_SendGoal)() {
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_fndm_interface
cdr_serialize(
  const ros2_fndm_interface::action::Fibonacci_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_fndm_interface::action::Fibonacci_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_fndm_interface::action::Fibonacci_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_fndm_interface::action::Fibonacci_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_fndm_interface::action::Fibonacci_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_fndm_interface, action, Fibonacci_GetResult_Request)() {
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for ros2_fndm_interface::action::Fibonacci_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_fndm_interface
cdr_serialize(
  const ros2_fndm_interface::action::Fibonacci_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_fndm_interface::action::Fibonacci_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_fndm_interface::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_fndm_interface::action::Fibonacci_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_fndm_interface::action::Fibonacci_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_fndm_interface::action::Fibonacci_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_fndm_interface, action, Fibonacci_GetResult_Response)() {
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Response__handle;
}
...
// functions for ros2_fndm_interface::action::Fibonacci_GetResult_Request already declared above

// functions for ros2_fndm_interface::action::Fibonacci_GetResult_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_fndm_interface
cdr_serialize(
  const ros2_fndm_interface::action::Fibonacci_GetResult_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  service_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_fndm_interface::action::Fibonacci_GetResult_Event & ros_message)
{
  // Member: info
  service_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.info);
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_fndm_interface::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_fndm_interface::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_fndm_interface::action::Fibonacci_GetResult_Event;
    is_plain =
      (
      offsetof(DataType, response) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const ros2_fndm_interface::action::Fibonacci_GetResult_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_fndm_interface::action::Fibonacci_GetResult_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_fndm_interface, action, Fibonacci_GetResult_Event)() {
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult_Event__handle;
}
...
static const rosidl_service_type_support_t _Fibonacci_GetResult__handle{
  ...
  get_service_typesupport_handle_function,
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<ros2_fndm_interface::action::Fibonacci_GetResult_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<ros2_fndm_interface::action::Fibonacci_GetResult_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<ros2_fndm_interface::action::Fibonacci_GetResult_Event>(),
...
{
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_fndm_interface, action, Fibonacci_GetResult)() {
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_GetResult__handle;
}
...
// functions for ros2_fndm_interface::action::Fibonacci_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros2_fndm_interface
cdr_serialize(
  const ros2_fndm_interface::action::Fibonacci_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros2_fndm_interface::action::Fibonacci_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros2_fndm_interface::action::typesupport_fastrtps_cpp::max_serialized_size_Fibonacci_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_fndm_interface::action::Fibonacci_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_fndm_interface::action::Fibonacci_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros2_fndm_interface::action::Fibonacci_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_fndm_interface, action, Fibonacci_FeedbackMessage)() {
  return &ros2_fndm_interface::action::typesupport_fastrtps_cpp::_Fibonacci_FeedbackMessage__handle;
}
