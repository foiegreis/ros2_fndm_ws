...
#include "ros2_fndm_interface/msg/detail/address_book__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_fndm_interface::msg::AddressBook;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros2_fndm_interface::msg::AddressBook *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros2_fndm_interface::msg::AddressBook *>(
    untyped_ros_message);
...
{
  return &ros2_fndm_interface::msg::typesupport_fastrtps_cpp::_AddressBook__handle;
}
