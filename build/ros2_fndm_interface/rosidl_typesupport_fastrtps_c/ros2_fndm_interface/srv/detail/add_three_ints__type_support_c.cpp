...
#include "ros2_fndm_interface/srv/detail/add_three_ints__rosidl_typesupport_fastrtps_c.h"
...
using _AddThreeInts_Request__ros_msg_type = ros2_fndm_interface__srv__AddThreeInts_Request;
...
size_t get_serialized_size_ros2_fndm_interface__srv__AddThreeInts_Request(
  const void * untyped_ros_message,
...
static uint32_t _AddThreeInts_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_fndm_interface__srv__AddThreeInts_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_fndm_interface
size_t max_serialized_size_ros2_fndm_interface__srv__AddThreeInts_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros2_fndm_interface__srv__AddThreeInts_Request;
    is_plain =
      (
      offsetof(DataType, c) +
      last_member_size
...
static size_t _AddThreeInts_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_fndm_interface__srv__AddThreeInts_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_fndm_interface, srv, AddThreeInts_Request)() {
...
using _AddThreeInts_Response__ros_msg_type = ros2_fndm_interface__srv__AddThreeInts_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_fndm_interface
size_t get_serialized_size_ros2_fndm_interface__srv__AddThreeInts_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AddThreeInts_Response__ros_msg_type * ros_message = static_cast<const _AddThreeInts_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_fndm_interface__srv__AddThreeInts_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_fndm_interface
size_t max_serialized_size_ros2_fndm_interface__srv__AddThreeInts_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_fndm_interface__srv__AddThreeInts_Response;
    is_plain =
      (
...
static size_t _AddThreeInts_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_fndm_interface__srv__AddThreeInts_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_fndm_interface, srv, AddThreeInts_Response)() {
...
using _AddThreeInts_Event__ros_msg_type = ros2_fndm_interface__srv__AddThreeInts_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros2_fndm_interface, srv, AddThreeInts_Request
      )()->data);
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ros2_fndm_interface, srv, AddThreeInts_Response
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      ros2_fndm_interface__srv__AddThreeInts_Request__Sequence__fini(&ros_message->request);
    }
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      ros2_fndm_interface__srv__AddThreeInts_Response__Sequence__fini(&ros_message->response);
    }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_fndm_interface
size_t get_serialized_size_ros2_fndm_interface__srv__AddThreeInts_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AddThreeInts_Event__ros_msg_type * ros_message = static_cast<const _AddThreeInts_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ros2_fndm_interface__srv__AddThreeInts_Request(
  ...
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ros2_fndm_interface__srv__AddThreeInts_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros2_fndm_interface__srv__AddThreeInts_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros2_fndm_interface
size_t max_serialized_size_ros2_fndm_interface__srv__AddThreeInts_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2_fndm_interface__srv__AddThreeInts_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ros2_fndm_interface__srv__AddThreeInts_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros2_fndm_interface__srv__AddThreeInts_Event;
    is_plain =
      (
...
static size_t _AddThreeInts_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros2_fndm_interface__srv__AddThreeInts_Event(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_fndm_interface, srv, AddThreeInts_Event)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros2_fndm_interface, srv, AddThreeInts)() {
