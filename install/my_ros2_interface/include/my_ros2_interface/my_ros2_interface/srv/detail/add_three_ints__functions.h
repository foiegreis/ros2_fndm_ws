...
#ifndef MY_ROS2_INTERFACE__SRV__DETAIL__ADD_THREE_INTS__FUNCTIONS_H_
#define MY_ROS2_INTERFACE__SRV__DETAIL__ADD_THREE_INTS__FUNCTIONS_H_
 ...
 * calls
 * my_ros2_interface__srv__AddThreeInts_Request__init().
...
/**
 * It calls
 * my_ros2_interface__srv__AddThreeInts_Request__fini()
...
/**
 * It calls
 * my_ros2_interface__srv__AddThreeInts_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_ros2_interface__srv__AddThreeInts_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_ros2_interface
...
/**
 * It calls
 * my_ros2_interface__srv__AddThreeInts_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_ros2_interface
...
/**
 * It calls
 * my_ros2_interface__srv__AddThreeInts_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * my_ros2_interface__srv__AddThreeInts_Event__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_ros2_interface
...
/**
 * It calls
 * my_ros2_interface__srv__AddThreeInts_Event__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_my_ros2_interface
...
/**
 * It allocates the memory for the array and calls
 * my_ros2_interface__srv__AddThreeInts_Event__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_my_ros2_interface
...
/**
 * It calls
 * my_ros2_interface__srv__AddThreeInts_Event__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MY_ROS2_INTERFACE__SRV__DETAIL__ADD_THREE_INTS__FUNCTIONS_H_
