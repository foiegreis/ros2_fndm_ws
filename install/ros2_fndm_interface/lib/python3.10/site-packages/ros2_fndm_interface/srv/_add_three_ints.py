...
class AddThreeInts_Event(metaclass=Metaclass_AddThreeInts_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<ros2_fndm_interface/AddThreeInts_Request, 1>',
        'response': 'sequence<ros2_fndm_interface/AddThreeInts_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros2_fndm_interface', 'srv'], 'AddThreeInts_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['ros2_fndm_interface', 'srv'], 'AddThreeInts_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from ros2_fndm_interface.srv import AddThreeInts_Request
    ...
    def response(self, value):
        if self._check_fields:
            from ros2_fndm_interface.srv import AddThreeInts_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class Metaclass_AddThreeInts(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'ros2_fndm_interface.srv.AddThreeInts')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from ros2_fndm_interface.srv import _add_three_ints
...
class AddThreeInts(metaclass=Metaclass_AddThreeInts):
    from ros2_fndm_interface.srv._add_three_ints import AddThreeInts_Request as Request
    from ros2_fndm_interface.srv._add_three_ints import AddThreeInts_Response as Response
    from ros2_fndm_interface.srv._add_three_ints import AddThreeInts_Event as Event
