...
ros2_fndm_interface__action__Fibonacci_Goal__create()
{
  ...
  ros2_fndm_interface__action__Fibonacci_Goal * msg = (ros2_fndm_interface__action__Fibonacci_Goal *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_Goal), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2_fndm_interface__action__Fibonacci_Goal));
  bool success = ros2_fndm_interface__action__Fibonacci_Goal__init(msg);
  if (!success) {
...
ros2_fndm_interface__action__Fibonacci_Goal__destroy(ros2_fndm_interface__action__Fibonacci_Goal * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    ros2_fndm_interface__action__Fibonacci_Goal__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
ros2_fndm_interface__action__Fibonacci_Goal__Sequence__init(ros2_fndm_interface__action__Fibonacci_Goal__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_Goal * data = NULL;

  if (size) {
    data = (ros2_fndm_interface__action__Fibonacci_Goal *)allocator.zero_allocate(size, sizeof(ros2_fndm_interface__action__Fibonacci_Goal), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2_fndm_interface__action__Fibonacci_Goal__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        ros2_fndm_interface__action__Fibonacci_Goal__fini(&data[i - 1]);
      }
...
ros2_fndm_interface__action__Fibonacci_Goal__Sequence__fini(ros2_fndm_interface__action__Fibonacci_Goal__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2_fndm_interface__action__Fibonacci_Goal__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_Goal__Sequence * array = (ros2_fndm_interface__action__Fibonacci_Goal__Sequence *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_Goal__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2_fndm_interface__action__Fibonacci_Goal__Sequence__init(array, size);
  if (!success) {
...
ros2_fndm_interface__action__Fibonacci_Goal__Sequence__destroy(ros2_fndm_interface__action__Fibonacci_Goal__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2_fndm_interface__action__Fibonacci_Goal__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2_fndm_interface__action__Fibonacci_Goal__Sequence__are_equal(const ros2_fndm_interface__action__Fibonacci_Goal__Sequence * lhs, const ros2_fndm_interface__action__Fibonacci_Goal__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_Goal__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2_fndm_interface__action__Fibonacci_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2_fndm_interface__action__Fibonacci_Goal);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2_fndm_interface__action__Fibonacci_Goal * data =
      (ros2_fndm_interface__action__Fibonacci_Goal *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_fndm_interface__action__Fibonacci_Goal__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_fndm_interface__action__Fibonacci_Goal__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_Goal__copy(
...
ros2_fndm_interface__action__Fibonacci_Result__init(ros2_fndm_interface__action__Fibonacci_Result * msg)
{
  ...
  if (!rosidl_runtime_c__int64__Sequence__init(&msg->result_sequence, 0)) {
    ros2_fndm_interface__action__Fibonacci_Result__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_Result * msg = (ros2_fndm_interface__action__Fibonacci_Result *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_Result), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2_fndm_interface__action__Fibonacci_Result));
  bool success = ros2_fndm_interface__action__Fibonacci_Result__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_Result__Sequence__init(ros2_fndm_interface__action__Fibonacci_Result__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_Result * data = NULL;

  if (size) {
    data = (ros2_fndm_interface__action__Fibonacci_Result *)allocator.zero_allocate(size, sizeof(ros2_fndm_interface__action__Fibonacci_Result), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2_fndm_interface__action__Fibonacci_Result__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2_fndm_interface__action__Fibonacci_Result__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_Result__Sequence__fini(ros2_fndm_interface__action__Fibonacci_Result__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2_fndm_interface__action__Fibonacci_Result__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_Result__Sequence * array = (ros2_fndm_interface__action__Fibonacci_Result__Sequence *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_Result__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2_fndm_interface__action__Fibonacci_Result__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_Result__Sequence__destroy(ros2_fndm_interface__action__Fibonacci_Result__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2_fndm_interface__action__Fibonacci_Result__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2_fndm_interface__action__Fibonacci_Result__Sequence__are_equal(const ros2_fndm_interface__action__Fibonacci_Result__Sequence * lhs, const ros2_fndm_interface__action__Fibonacci_Result__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_Result__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2_fndm_interface__action__Fibonacci_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2_fndm_interface__action__Fibonacci_Result);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2_fndm_interface__action__Fibonacci_Result * data =
      (ros2_fndm_interface__action__Fibonacci_Result *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_fndm_interface__action__Fibonacci_Result__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_fndm_interface__action__Fibonacci_Result__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_Result__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_Feedback__init(ros2_fndm_interface__action__Fibonacci_Feedback * msg)
{
  ...
  if (!rosidl_runtime_c__int64__Sequence__init(&msg->partial_sequence, 0)) {
    ros2_fndm_interface__action__Fibonacci_Feedback__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_Feedback * msg = (ros2_fndm_interface__action__Fibonacci_Feedback *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_Feedback), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2_fndm_interface__action__Fibonacci_Feedback));
  bool success = ros2_fndm_interface__action__Fibonacci_Feedback__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_Feedback__Sequence__init(ros2_fndm_interface__action__Fibonacci_Feedback__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_Feedback * data = NULL;

  if (size) {
    data = (ros2_fndm_interface__action__Fibonacci_Feedback *)allocator.zero_allocate(size, sizeof(ros2_fndm_interface__action__Fibonacci_Feedback), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2_fndm_interface__action__Fibonacci_Feedback__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2_fndm_interface__action__Fibonacci_Feedback__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_Feedback__Sequence__fini(ros2_fndm_interface__action__Fibonacci_Feedback__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2_fndm_interface__action__Fibonacci_Feedback__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_Feedback__Sequence * array = (ros2_fndm_interface__action__Fibonacci_Feedback__Sequence *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_Feedback__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2_fndm_interface__action__Fibonacci_Feedback__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_Feedback__Sequence__destroy(ros2_fndm_interface__action__Fibonacci_Feedback__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2_fndm_interface__action__Fibonacci_Feedback__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2_fndm_interface__action__Fibonacci_Feedback__Sequence__are_equal(const ros2_fndm_interface__action__Fibonacci_Feedback__Sequence * lhs, const ros2_fndm_interface__action__Fibonacci_Feedback__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_Feedback__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2_fndm_interface__action__Fibonacci_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2_fndm_interface__action__Fibonacci_Feedback);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2_fndm_interface__action__Fibonacci_Feedback * data =
      (ros2_fndm_interface__action__Fibonacci_Feedback *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_fndm_interface__action__Fibonacci_Feedback__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_fndm_interface__action__Fibonacci_Feedback__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_Feedback__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Request__init(ros2_fndm_interface__action__Fibonacci_SendGoal_Request * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    ros2_fndm_interface__action__Fibonacci_SendGoal_Request__fini(msg);
    return false;
  }
  // goal
  if (!ros2_fndm_interface__action__Fibonacci_Goal__init(&msg->goal)) {
    ros2_fndm_interface__action__Fibonacci_SendGoal_Request__fini(msg);
    return false;
  }
  return true;
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Request__fini(ros2_fndm_interface__action__Fibonacci_SendGoal_Request * msg)
{
  ...
  // goal
  ros2_fndm_interface__action__Fibonacci_Goal__fini(&msg->goal);
}
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Request__are_equal(const ros2_fndm_interface__action__Fibonacci_SendGoal_Request * lhs, const ros2_fndm_interface__action__Fibonacci_SendGoal_Request * rhs)
{
  ...
  // goal
  if (!ros2_fndm_interface__action__Fibonacci_Goal__are_equal(
      &(lhs->goal), &(rhs->goal)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_SendGoal_Request * msg = (ros2_fndm_interface__action__Fibonacci_SendGoal_Request *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_SendGoal_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2_fndm_interface__action__Fibonacci_SendGoal_Request));
  bool success = ros2_fndm_interface__action__Fibonacci_SendGoal_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence__init(ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_SendGoal_Request * data = NULL;

  if (size) {
    data = (ros2_fndm_interface__action__Fibonacci_SendGoal_Request *)allocator.zero_allocate(size, sizeof(ros2_fndm_interface__action__Fibonacci_SendGoal_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2_fndm_interface__action__Fibonacci_SendGoal_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2_fndm_interface__action__Fibonacci_SendGoal_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence__fini(ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2_fndm_interface__action__Fibonacci_SendGoal_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence * array = (ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence__destroy(ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence__are_equal(const ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence * lhs, const ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_SendGoal_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2_fndm_interface__action__Fibonacci_SendGoal_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2_fndm_interface__action__Fibonacci_SendGoal_Request * data =
      (ros2_fndm_interface__action__Fibonacci_SendGoal_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_fndm_interface__action__Fibonacci_SendGoal_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_fndm_interface__action__Fibonacci_SendGoal_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_SendGoal_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Response__init(ros2_fndm_interface__action__Fibonacci_SendGoal_Response * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    ros2_fndm_interface__action__Fibonacci_SendGoal_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_SendGoal_Response * msg = (ros2_fndm_interface__action__Fibonacci_SendGoal_Response *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_SendGoal_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2_fndm_interface__action__Fibonacci_SendGoal_Response));
  bool success = ros2_fndm_interface__action__Fibonacci_SendGoal_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence__init(ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_SendGoal_Response * data = NULL;

  if (size) {
    data = (ros2_fndm_interface__action__Fibonacci_SendGoal_Response *)allocator.zero_allocate(size, sizeof(ros2_fndm_interface__action__Fibonacci_SendGoal_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2_fndm_interface__action__Fibonacci_SendGoal_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2_fndm_interface__action__Fibonacci_SendGoal_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence__fini(ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2_fndm_interface__action__Fibonacci_SendGoal_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence * array = (ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence__destroy(ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence__are_equal(const ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence * lhs, const ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_SendGoal_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2_fndm_interface__action__Fibonacci_SendGoal_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2_fndm_interface__action__Fibonacci_SendGoal_Response * data =
      (ros2_fndm_interface__action__Fibonacci_SendGoal_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_fndm_interface__action__Fibonacci_SendGoal_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_fndm_interface__action__Fibonacci_SendGoal_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_SendGoal_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Event__init(ros2_fndm_interface__action__Fibonacci_SendGoal_Event * msg)
{
  ...
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    ros2_fndm_interface__action__Fibonacci_SendGoal_Event__fini(msg);
    return false;
  }
  // request
  if (!ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence__init(&msg->request, 0)) {
    ros2_fndm_interface__action__Fibonacci_SendGoal_Event__fini(msg);
    return false;
  }
  // response
  if (!ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence__init(&msg->response, 0)) {
    ros2_fndm_interface__action__Fibonacci_SendGoal_Event__fini(msg);
    return false;
  }
  return true;
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Event__fini(ros2_fndm_interface__action__Fibonacci_SendGoal_Event * msg)
{
  ...
  // request
  ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence__fini(&msg->request);
  // response
  ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence__fini(&msg->response);
}
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Event__are_equal(const ros2_fndm_interface__action__Fibonacci_SendGoal_Event * lhs, const ros2_fndm_interface__action__Fibonacci_SendGoal_Event * rhs)
{
  ...
  // request
  if (!ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence__are_equal(
  ...
  ros2_fndm_interface__action__Fibonacci_SendGoal_Event * output)
{
  ...
  // request
  if (!ros2_fndm_interface__action__Fibonacci_SendGoal_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!ros2_fndm_interface__action__Fibonacci_SendGoal_Response__Sequence__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_SendGoal_Event * msg = (ros2_fndm_interface__action__Fibonacci_SendGoal_Event *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_SendGoal_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2_fndm_interface__action__Fibonacci_SendGoal_Event));
  bool success = ros2_fndm_interface__action__Fibonacci_SendGoal_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Event__Sequence__init(ros2_fndm_interface__action__Fibonacci_SendGoal_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_SendGoal_Event * data = NULL;

  if (size) {
    data = (ros2_fndm_interface__action__Fibonacci_SendGoal_Event *)allocator.zero_allocate(size, sizeof(ros2_fndm_interface__action__Fibonacci_SendGoal_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2_fndm_interface__action__Fibonacci_SendGoal_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2_fndm_interface__action__Fibonacci_SendGoal_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Event__Sequence__fini(ros2_fndm_interface__action__Fibonacci_SendGoal_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2_fndm_interface__action__Fibonacci_SendGoal_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_SendGoal_Event__Sequence * array = (ros2_fndm_interface__action__Fibonacci_SendGoal_Event__Sequence *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_SendGoal_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2_fndm_interface__action__Fibonacci_SendGoal_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Event__Sequence__destroy(ros2_fndm_interface__action__Fibonacci_SendGoal_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2_fndm_interface__action__Fibonacci_SendGoal_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2_fndm_interface__action__Fibonacci_SendGoal_Event__Sequence__are_equal(const ros2_fndm_interface__action__Fibonacci_SendGoal_Event__Sequence * lhs, const ros2_fndm_interface__action__Fibonacci_SendGoal_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_SendGoal_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2_fndm_interface__action__Fibonacci_SendGoal_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2_fndm_interface__action__Fibonacci_SendGoal_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2_fndm_interface__action__Fibonacci_SendGoal_Event * data =
      (ros2_fndm_interface__action__Fibonacci_SendGoal_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_fndm_interface__action__Fibonacci_SendGoal_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_fndm_interface__action__Fibonacci_SendGoal_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_SendGoal_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_GetResult_Request__init(ros2_fndm_interface__action__Fibonacci_GetResult_Request * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    ros2_fndm_interface__action__Fibonacci_GetResult_Request__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_GetResult_Request * msg = (ros2_fndm_interface__action__Fibonacci_GetResult_Request *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_GetResult_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2_fndm_interface__action__Fibonacci_GetResult_Request));
  bool success = ros2_fndm_interface__action__Fibonacci_GetResult_Request__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence__init(ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_GetResult_Request * data = NULL;

  if (size) {
    data = (ros2_fndm_interface__action__Fibonacci_GetResult_Request *)allocator.zero_allocate(size, sizeof(ros2_fndm_interface__action__Fibonacci_GetResult_Request), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2_fndm_interface__action__Fibonacci_GetResult_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2_fndm_interface__action__Fibonacci_GetResult_Request__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence__fini(ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2_fndm_interface__action__Fibonacci_GetResult_Request__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence * array = (ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence__destroy(ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence__are_equal(const ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence * lhs, const ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_GetResult_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2_fndm_interface__action__Fibonacci_GetResult_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2_fndm_interface__action__Fibonacci_GetResult_Request * data =
      (ros2_fndm_interface__action__Fibonacci_GetResult_Request *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_fndm_interface__action__Fibonacci_GetResult_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_fndm_interface__action__Fibonacci_GetResult_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_GetResult_Request__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_GetResult_Response__init(ros2_fndm_interface__action__Fibonacci_GetResult_Response * msg)
{
  ...
  // status
  // result
  if (!ros2_fndm_interface__action__Fibonacci_Result__init(&msg->result)) {
    ros2_fndm_interface__action__Fibonacci_GetResult_Response__fini(msg);
    return false;
  }
  return true;
}
...
ros2_fndm_interface__action__Fibonacci_GetResult_Response__fini(ros2_fndm_interface__action__Fibonacci_GetResult_Response * msg)
{
  ...
  // status
  // result
  ros2_fndm_interface__action__Fibonacci_Result__fini(&msg->result);
}
...
ros2_fndm_interface__action__Fibonacci_GetResult_Response__are_equal(const ros2_fndm_interface__action__Fibonacci_GetResult_Response * lhs, const ros2_fndm_interface__action__Fibonacci_GetResult_Response * rhs)
{
  ...
  // result
  if (!ros2_fndm_interface__action__Fibonacci_Result__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_GetResult_Response * msg = (ros2_fndm_interface__action__Fibonacci_GetResult_Response *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_GetResult_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2_fndm_interface__action__Fibonacci_GetResult_Response));
  bool success = ros2_fndm_interface__action__Fibonacci_GetResult_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence__init(ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_GetResult_Response * data = NULL;

  if (size) {
    data = (ros2_fndm_interface__action__Fibonacci_GetResult_Response *)allocator.zero_allocate(size, sizeof(ros2_fndm_interface__action__Fibonacci_GetResult_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2_fndm_interface__action__Fibonacci_GetResult_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2_fndm_interface__action__Fibonacci_GetResult_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence__fini(ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2_fndm_interface__action__Fibonacci_GetResult_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence * array = (ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence__destroy(ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence__are_equal(const ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence * lhs, const ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_GetResult_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2_fndm_interface__action__Fibonacci_GetResult_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2_fndm_interface__action__Fibonacci_GetResult_Response * data =
      (ros2_fndm_interface__action__Fibonacci_GetResult_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_fndm_interface__action__Fibonacci_GetResult_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_fndm_interface__action__Fibonacci_GetResult_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_GetResult_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_GetResult_Event__init(ros2_fndm_interface__action__Fibonacci_GetResult_Event * msg)
{
  ...
  // info
  if (!service_msgs__msg__ServiceEventInfo__init(&msg->info)) {
    ros2_fndm_interface__action__Fibonacci_GetResult_Event__fini(msg);
    return false;
  }
  // request
  if (!ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence__init(&msg->request, 0)) {
    ros2_fndm_interface__action__Fibonacci_GetResult_Event__fini(msg);
    return false;
  }
  // response
  if (!ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence__init(&msg->response, 0)) {
    ros2_fndm_interface__action__Fibonacci_GetResult_Event__fini(msg);
    return false;
  }
  return true;
...
ros2_fndm_interface__action__Fibonacci_GetResult_Event__fini(ros2_fndm_interface__action__Fibonacci_GetResult_Event * msg)
{
  ...
  service_msgs__msg__ServiceEventInfo__fini(&msg->info);
  // request
  ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence__fini(&msg->request);
  // response
  ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence__fini(&msg->response);
}
...
ros2_fndm_interface__action__Fibonacci_GetResult_Event__are_equal(const ros2_fndm_interface__action__Fibonacci_GetResult_Event * lhs, const ros2_fndm_interface__action__Fibonacci_GetResult_Event * rhs)
{
  ...
  // request
  if (!ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence__are_equal(
      &(lhs->request), &(rhs->request)))
  {
    return false;
  }
  // response
  if (!ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence__are_equal(
      &(lhs->response), &(rhs->response)))
  {
    return false;
  }
  ...
  ros2_fndm_interface__action__Fibonacci_GetResult_Event * output)
{
  ...
  // request
  if (!ros2_fndm_interface__action__Fibonacci_GetResult_Request__Sequence__copy(
      &(input->request), &(output->request)))
  {
    return false;
  }
  // response
  if (!ros2_fndm_interface__action__Fibonacci_GetResult_Response__Sequence__copy(
      &(input->response), &(output->response)))
  {
    return false;
  }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_GetResult_Event * msg = (ros2_fndm_interface__action__Fibonacci_GetResult_Event *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_GetResult_Event), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2_fndm_interface__action__Fibonacci_GetResult_Event));
  bool success = ros2_fndm_interface__action__Fibonacci_GetResult_Event__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_GetResult_Event__Sequence__init(ros2_fndm_interface__action__Fibonacci_GetResult_Event__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_GetResult_Event * data = NULL;

  if (size) {
    data = (ros2_fndm_interface__action__Fibonacci_GetResult_Event *)allocator.zero_allocate(size, sizeof(ros2_fndm_interface__action__Fibonacci_GetResult_Event), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2_fndm_interface__action__Fibonacci_GetResult_Event__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2_fndm_interface__action__Fibonacci_GetResult_Event__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_GetResult_Event__Sequence__fini(ros2_fndm_interface__action__Fibonacci_GetResult_Event__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2_fndm_interface__action__Fibonacci_GetResult_Event__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_GetResult_Event__Sequence * array = (ros2_fndm_interface__action__Fibonacci_GetResult_Event__Sequence *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_GetResult_Event__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2_fndm_interface__action__Fibonacci_GetResult_Event__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_GetResult_Event__Sequence__destroy(ros2_fndm_interface__action__Fibonacci_GetResult_Event__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2_fndm_interface__action__Fibonacci_GetResult_Event__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2_fndm_interface__action__Fibonacci_GetResult_Event__Sequence__are_equal(const ros2_fndm_interface__action__Fibonacci_GetResult_Event__Sequence * lhs, const ros2_fndm_interface__action__Fibonacci_GetResult_Event__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_GetResult_Event__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2_fndm_interface__action__Fibonacci_GetResult_Event__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2_fndm_interface__action__Fibonacci_GetResult_Event);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2_fndm_interface__action__Fibonacci_GetResult_Event * data =
      (ros2_fndm_interface__action__Fibonacci_GetResult_Event *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_fndm_interface__action__Fibonacci_GetResult_Event__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_fndm_interface__action__Fibonacci_GetResult_Event__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_GetResult_Event__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_FeedbackMessage__init(ros2_fndm_interface__action__Fibonacci_FeedbackMessage * msg)
{
  ...
  // goal_id
  if (!unique_identifier_msgs__msg__UUID__init(&msg->goal_id)) {
    ros2_fndm_interface__action__Fibonacci_FeedbackMessage__fini(msg);
    return false;
  }
  // feedback
  if (!ros2_fndm_interface__action__Fibonacci_Feedback__init(&msg->feedback)) {
    ros2_fndm_interface__action__Fibonacci_FeedbackMessage__fini(msg);
    return false;
  }
  return true;
...
ros2_fndm_interface__action__Fibonacci_FeedbackMessage__fini(ros2_fndm_interface__action__Fibonacci_FeedbackMessage * msg)
{
  ...
  unique_identifier_msgs__msg__UUID__fini(&msg->goal_id);
  // feedback
  ros2_fndm_interface__action__Fibonacci_Feedback__fini(&msg->feedback);
}
...
ros2_fndm_interface__action__Fibonacci_FeedbackMessage__are_equal(const ros2_fndm_interface__action__Fibonacci_FeedbackMessage * lhs, const ros2_fndm_interface__action__Fibonacci_FeedbackMessage * rhs)
{
  ...
  // feedback
  if (!ros2_fndm_interface__action__Fibonacci_Feedback__are_equal(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_FeedbackMessage * msg = (ros2_fndm_interface__action__Fibonacci_FeedbackMessage *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_FeedbackMessage), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(ros2_fndm_interface__action__Fibonacci_FeedbackMessage));
  bool success = ros2_fndm_interface__action__Fibonacci_FeedbackMessage__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_FeedbackMessage__Sequence__init(ros2_fndm_interface__action__Fibonacci_FeedbackMessage__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_FeedbackMessage * data = NULL;

  if (size) {
    data = (ros2_fndm_interface__action__Fibonacci_FeedbackMessage *)allocator.zero_allocate(size, sizeof(ros2_fndm_interface__action__Fibonacci_FeedbackMessage), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = ros2_fndm_interface__action__Fibonacci_FeedbackMessage__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        ros2_fndm_interface__action__Fibonacci_FeedbackMessage__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
ros2_fndm_interface__action__Fibonacci_FeedbackMessage__Sequence__fini(ros2_fndm_interface__action__Fibonacci_FeedbackMessage__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      ros2_fndm_interface__action__Fibonacci_FeedbackMessage__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  ros2_fndm_interface__action__Fibonacci_FeedbackMessage__Sequence * array = (ros2_fndm_interface__action__Fibonacci_FeedbackMessage__Sequence *)allocator.allocate(sizeof(ros2_fndm_interface__action__Fibonacci_FeedbackMessage__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = ros2_fndm_interface__action__Fibonacci_FeedbackMessage__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
ros2_fndm_interface__action__Fibonacci_FeedbackMessage__Sequence__destroy(ros2_fndm_interface__action__Fibonacci_FeedbackMessage__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    ros2_fndm_interface__action__Fibonacci_FeedbackMessage__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
ros2_fndm_interface__action__Fibonacci_FeedbackMessage__Sequence__are_equal(const ros2_fndm_interface__action__Fibonacci_FeedbackMessage__Sequence * lhs, const ros2_fndm_interface__action__Fibonacci_FeedbackMessage__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_FeedbackMessage__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  ros2_fndm_interface__action__Fibonacci_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(ros2_fndm_interface__action__Fibonacci_FeedbackMessage);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    ros2_fndm_interface__action__Fibonacci_FeedbackMessage * data =
      (ros2_fndm_interface__action__Fibonacci_FeedbackMessage *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!ros2_fndm_interface__action__Fibonacci_FeedbackMessage__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          ros2_fndm_interface__action__Fibonacci_FeedbackMessage__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!ros2_fndm_interface__action__Fibonacci_FeedbackMessage__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
