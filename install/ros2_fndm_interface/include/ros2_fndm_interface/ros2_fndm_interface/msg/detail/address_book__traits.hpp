...
#ifndef ROS2_FNDM_INTERFACE__MSG__DETAIL__ADDRESS_BOOK__TRAITS_HPP_
#define ROS2_FNDM_INTERFACE__MSG__DETAIL__ADDRESS_BOOK__TRAITS_HPP_
...
inline void to_yaml(
  const ros2_fndm_interface::msg::AddressBook & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const ros2_fndm_interface::msg::AddressBook & msg)
{
  return ros2_fndm_interface::msg::to_yaml(msg);
}

template<>
inline const char * data_type<ros2_fndm_interface::msg::AddressBook>()
{
  return "ros2_fndm_interface::msg::AddressBook";
}

template<>
inline const char * name<ros2_fndm_interface::msg::AddressBook>()
{
  return "ros2_fndm_interface/msg/AddressBook";
}

template<>
struct has_fixed_size<ros2_fndm_interface::msg::AddressBook>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<ros2_fndm_interface::msg::AddressBook>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<ros2_fndm_interface::msg::AddressBook>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // ROS2_FNDM_INTERFACE__MSG__DETAIL__ADDRESS_BOOK__TRAITS_HPP_
