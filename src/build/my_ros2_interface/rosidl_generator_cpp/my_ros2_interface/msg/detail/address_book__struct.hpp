...
#ifndef MY_ROS2_INTERFACE__MSG__DETAIL__ADDRESS_BOOK__STRUCT_HPP_
#define MY_ROS2_INTERFACE__MSG__DETAIL__ADDRESS_BOOK__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__my_ros2_interface__msg__AddressBook __attribute__((deprecated))
#else
# define DEPRECATED__my_ros2_interface__msg__AddressBook __declspec(deprecated)
#endif
...
struct AddressBook_
{
  ...
  // pointer types
  using RawPtr =
    my_ros2_interface::msg::AddressBook_<ContainerAllocator> *;
  using ConstRawPtr =
    const my_ros2_interface::msg::AddressBook_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<my_ros2_interface::msg::AddressBook_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<my_ros2_interface::msg::AddressBook_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      my_ros2_interface::msg::AddressBook_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<my_ros2_interface::msg::AddressBook_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<my_ros2_interface::msg::AddressBook_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<my_ros2_interface::msg::AddressBook_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<my_ros2_interface::msg::AddressBook_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__my_ros2_interface__msg__AddressBook
    std::shared_ptr<my_ros2_interface::msg::AddressBook_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__my_ros2_interface__msg__AddressBook
    std::shared_ptr<my_ros2_interface::msg::AddressBook_<ContainerAllocator> const>
...
using AddressBook =
  my_ros2_interface::msg::AddressBook_<std::allocator<void>>;
...
#endif  // MY_ROS2_INTERFACE__MSG__DETAIL__ADDRESS_BOOK__STRUCT_HPP_
