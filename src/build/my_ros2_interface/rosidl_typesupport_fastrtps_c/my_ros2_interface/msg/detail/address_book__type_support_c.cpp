...
#include "my_ros2_interface/msg/detail/address_book__rosidl_typesupport_fastrtps_c.h"
...
using _AddressBook__ros_msg_type = my_ros2_interface__msg__AddressBook;
...
size_t get_serialized_size_my_ros2_interface__msg__AddressBook(
  const void * untyped_ros_message,
...
static uint32_t _AddressBook__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_my_ros2_interface__msg__AddressBook(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_my_ros2_interface
size_t max_serialized_size_my_ros2_interface__msg__AddressBook(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_ros2_interface__msg__AddressBook;
    is_plain =
      (
...
static size_t _AddressBook__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_my_ros2_interface__msg__AddressBook(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_ros2_interface, msg, AddressBook)() {
