...
{
  new (message_memory) my_ros2_interface::srv::AddThreeInts_Request(_init);
}

void AddThreeInts_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_ros2_interface::srv::AddThreeInts_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AddThreeInts_Request_message_member_array[3] = {
  {
    ...
    offsetof(my_ros2_interface::srv::AddThreeInts_Request, a),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_ros2_interface::srv::AddThreeInts_Request, b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_ros2_interface::srv::AddThreeInts_Request, c),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AddThreeInts_Request_message_members = {
  "my_ros2_interface::srv",  // message namespace
  "AddThreeInts_Request",  // message name
  3,  // number of fields
  sizeof(my_ros2_interface::srv::AddThreeInts_Request),
...
get_message_type_support_handle<my_ros2_interface::srv::AddThreeInts_Request>()
{
  return &::my_ros2_interface::srv::rosidl_typesupport_introspection_cpp::AddThreeInts_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_ros2_interface, srv, AddThreeInts_Request)() {
  return &::my_ros2_interface::srv::rosidl_typesupport_introspection_cpp::AddThreeInts_Request_message_type_support_handle;
}
...
void AddThreeInts_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) my_ros2_interface::srv::AddThreeInts_Response(_init);
}

void AddThreeInts_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_ros2_interface::srv::AddThreeInts_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AddThreeInts_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_ros2_interface::srv::AddThreeInts_Response, sum),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AddThreeInts_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(my_ros2_interface::srv::AddThreeInts_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<my_ros2_interface::srv::AddThreeInts_Response>()
{
  return &::my_ros2_interface::srv::rosidl_typesupport_introspection_cpp::AddThreeInts_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_ros2_interface, srv, AddThreeInts_Response)() {
  return &::my_ros2_interface::srv::rosidl_typesupport_introspection_cpp::AddThreeInts_Response_message_type_support_handle;
}
...
void AddThreeInts_Event_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) my_ros2_interface::srv::AddThreeInts_Event(_init);
}

void AddThreeInts_Event_fini_function(void * message_memory)
{
  auto typed_message = static_cast<my_ros2_interface::srv::AddThreeInts_Event *>(message_memory);
  typed_message->~AddThreeInts_Event();
}

size_t size_function__AddThreeInts_Event__request(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<my_ros2_interface::srv::AddThreeInts_Request> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<my_ros2_interface::srv::AddThreeInts_Request> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<my_ros2_interface::srv::AddThreeInts_Request> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const my_ros2_interface::srv::AddThreeInts_Request *>(
    get_const_function__AddThreeInts_Event__request(untyped_member, index));
  auto & value = *reinterpret_cast<my_ros2_interface::srv::AddThreeInts_Request *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<my_ros2_interface::srv::AddThreeInts_Request *>(
    get_function__AddThreeInts_Event__request(untyped_member, index));
  const auto & value = *reinterpret_cast<const my_ros2_interface::srv::AddThreeInts_Request *>(untyped_value);
  item = value;
}
...
{
  const auto * member = reinterpret_cast<const std::vector<my_ros2_interface::srv::AddThreeInts_Response> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<my_ros2_interface::srv::AddThreeInts_Response> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<my_ros2_interface::srv::AddThreeInts_Response> *>(untyped_member);
  return &member[index];
}
...
void fetch_function__AddThreeInts_Event__response(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const my_ros2_interface::srv::AddThreeInts_Response *>(
    get_const_function__AddThreeInts_Event__response(untyped_member, index));
  auto & value = *reinterpret_cast<my_ros2_interface::srv::AddThreeInts_Response *>(untyped_value);
  value = item;
}
...
void assign_function__AddThreeInts_Event__response(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<my_ros2_interface::srv::AddThreeInts_Response *>(
    get_function__AddThreeInts_Event__response(untyped_member, index));
  const auto & value = *reinterpret_cast<const my_ros2_interface::srv::AddThreeInts_Response *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember AddThreeInts_Event_message_member_array[3] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(my_ros2_interface::srv::AddThreeInts_Event, info),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<my_ros2_interface::srv::AddThreeInts_Request>(),  // members of sub message
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(my_ros2_interface::srv::AddThreeInts_Event, request),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_MESSAGE,  // type
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<my_ros2_interface::srv::AddThreeInts_Response>(),  // members of sub message
    true,  // is array
    1,  // array size
    true,  // is upper bound
    offsetof(my_ros2_interface::srv::AddThreeInts_Event, response),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers AddThreeInts_Event_message_members = {
  ...
  3,  // number of fields
  sizeof(my_ros2_interface::srv::AddThreeInts_Event),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<my_ros2_interface::srv::AddThreeInts_Event>()
{
  return &::my_ros2_interface::srv::rosidl_typesupport_introspection_cpp::AddThreeInts_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_ros2_interface, srv, AddThreeInts_Event)() {
  return &::my_ros2_interface::srv::rosidl_typesupport_introspection_cpp::AddThreeInts_Event_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers AddThreeInts_service_members = {
  "my_ros2_interface::srv",  // service namespace
  "AddThreeInts",  // service name
  // these two fields are initialized below on the first access
  // see get_service_type_support_handle<my_ros2_interface::srv::AddThreeInts>()
...
static const rosidl_service_type_support_t AddThreeInts_service_type_support_handle = {
  ...
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<my_ros2_interface::srv::AddThreeInts_Request>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<my_ros2_interface::srv::AddThreeInts_Response>(),
  ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<my_ros2_interface::srv::AddThreeInts_Event>(),
  &::rosidl_typesupport_cpp::service_create_event_message<my_ros2_interface::srv::AddThreeInts>,
  &::rosidl_typesupport_cpp::service_destroy_event_message<my_ros2_interface::srv::AddThreeInts>,
...
get_service_type_support_handle<my_ros2_interface::srv::AddThreeInts>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::my_ros2_interface::srv::rosidl_typesupport_introspection_cpp::AddThreeInts_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_ros2_interface, srv, AddThreeInts)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<my_ros2_interface::srv::AddThreeInts>();
}
