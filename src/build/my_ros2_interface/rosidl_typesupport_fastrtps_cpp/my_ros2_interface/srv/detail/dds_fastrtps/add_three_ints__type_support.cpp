...
#include "my_ros2_interface/srv/detail/add_three_ints__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const my_ros2_interface::srv::AddThreeInts_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_ros2_interface::srv::AddThreeInts_Request & ros_message)
{
  // Member: a
  cdr >> ros_message.a;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_ros2_interface::srv::AddThreeInts_Request;
    is_plain =
      (
      offsetof(DataType, c) +
      last_member_size
...
{
  auto typed_message =
    static_cast<const my_ros2_interface::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_ros2_interface::srv::AddThreeInts_Request *>(
    untyped_ros_message);
...
{
  return &my_ros2_interface::srv::typesupport_fastrtps_cpp::_AddThreeInts_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_ros2_interface, srv, AddThreeInts_Request)() {
  return &my_ros2_interface::srv::typesupport_fastrtps_cpp::_AddThreeInts_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_ros2_interface
cdr_serialize(
  const my_ros2_interface::srv::AddThreeInts_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: sum
  cdr << ros_message.sum;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_ros2_interface::srv::AddThreeInts_Response & ros_message)
{
  // Member: sum
  cdr >> ros_message.sum;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_ros2_interface::srv::AddThreeInts_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_ros2_interface::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_ros2_interface::srv::AddThreeInts_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_ros2_interface::srv::typesupport_fastrtps_cpp::_AddThreeInts_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_ros2_interface, srv, AddThreeInts_Response)() {
  return &my_ros2_interface::srv::typesupport_fastrtps_cpp::_AddThreeInts_Response__handle;
}
...
// functions for my_ros2_interface::srv::AddThreeInts_Request already declared above

// functions for my_ros2_interface::srv::AddThreeInts_Response already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_my_ros2_interface
cdr_serialize(
  const my_ros2_interface::srv::AddThreeInts_Event & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      my_ros2_interface::srv::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  my_ros2_interface::srv::AddThreeInts_Event & ros_message)
{
  // Member: info
  ...
  // Member: request
  {
    ...
    for (size_t i = 0; i < size; i++) {
      my_ros2_interface::srv::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        my_ros2_interface::srv::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_ros2_interface::srv::typesupport_fastrtps_cpp::max_serialized_size_AddThreeInts_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // Member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        my_ros2_interface::srv::typesupport_fastrtps_cpp::max_serialized_size_AddThreeInts_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_ros2_interface::srv::AddThreeInts_Event;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_ros2_interface::srv::AddThreeInts_Event *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_ros2_interface::srv::AddThreeInts_Event *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &my_ros2_interface::srv::typesupport_fastrtps_cpp::_AddThreeInts_Event__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_ros2_interface, srv, AddThreeInts_Event)() {
  return &my_ros2_interface::srv::typesupport_fastrtps_cpp::_AddThreeInts_Event__handle;
}
...
static const rosidl_service_type_support_t _AddThreeInts__handle{
  ...
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<my_ros2_interface::srv::AddThreeInts_Request>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<my_ros2_interface::srv::AddThreeInts_Response>(),
  ::rosidl_typesupport_fastrtps_cpp::get_message_type_support_handle<my_ros2_interface::srv::AddThreeInts_Event>(),
...
{
  return &my_ros2_interface::srv::typesupport_fastrtps_cpp::_AddThreeInts__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_ros2_interface, srv, AddThreeInts)() {
  return &my_ros2_interface::srv::typesupport_fastrtps_cpp::_AddThreeInts__handle;
}
